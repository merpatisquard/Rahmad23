...
\t██████╦╝██║░░██║╚██████╔╝███████╗
\t╚═════╝░╚═╝░░╚═╝░╚═════╝░╚══════╝
			{m}•{k}•{h}•{sir} Author : NAZRI-XD {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	gh = 'github.com/NAZRIXD22'
	cetak(nel('\tSelamat Datang [yellow]%s[white] Ngentod'%(my_name)));os.system("play-audio NAZRI-XD.mp3")
	...
	if _____alvino__adijaya_____ in ['1']:
		...
		back()
def error():
	print(f'{k}>> Maaf Om Yaa Ini Masih Error 404😝 {x}')
	time.sleep(4)
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
